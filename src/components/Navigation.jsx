        ...
        <div className="bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md rounded-2xl shadow-lg border border-neutral-200/50 dark:border-neutral-700/50 px-6 py-3">
          <div className="flex items-center justify-between">
            ...
            {location.pathname === "/" ? (
              <button 
                onClick={scrollToTop}
                className="text-lg md:text-xl font-bold text-neutral-800 dark:text-white hover:text-neutral-600 dark:hover:text-neutral-300 transition-all duration-200 font-headline"
              >
                Jamie Treyvaud
              </button>
            ) : (
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="relative flex bg-neutral-100 dark:bg-neutral-800 rounded-full p-1">
                ...
                <button
                  ...
                  title="Light mode"
                >
                  <svg className={`w-4 h-4 ${theme === 'light' ? 'text-yellow-500' : 'text-neutral-400 dark:text-neutral-500'}`} fill="currentColor" viewBox="0 0 20 20">
                ...
                <button
                  ...
                  title="Dark mode"
                >
                  <svg className={`w-4 h-4 ${theme === 'dark' ? 'text-blue-400' : 'text-neutral-400 dark:text-neutral-500'}`} fill="currentColor" viewBox="0 0 20 20">
